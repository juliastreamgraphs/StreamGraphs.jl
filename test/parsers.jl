...
@test events[8]==Event(1.025,false,("a","b"))

events=parse_to_events("./test_data/auv_test_1.txt","auv",0.1)
@test length(events)==6
@test events[1]==Event(-0.05,true,("a","b"))
@test events[2]==Event(0.05,false,("a","b"))
@test events[3]==Event(0.45,true,("a","c"))
@test events[4]==Event(0.65,false,("a","c"))
@test events[5]==Event(0.95,true,("a","b"))
@test events[6]==Event(1.05,false,("a","b"))

events=parse_to_events("./test_data/auv_test_1.txt","auv",1.0)
@test length(events)==4
@test events[1]==Event(-0.5,true,("a","b"))
@test events[2]==Event(0.0,true,("a","c"))
@test events[3]==Event(1.1,false,("a","c"))
@test events[4]==Event(1.5,false,("a","b"))